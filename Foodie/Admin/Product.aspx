                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="form-group">
                                                    <label>Product Quantity(VND)</label>
                                                    <div>
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                                            ErrorMessage="Quantity must be none negative" ForeColor="Red" Display="Dynamic"
                                        ...
                                        <div class="col-sm-6 col-md-8 col-lg-8 mobile-inputs">
                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-reponsive">
                                                    ...
                                                    <asp:Repeater ID="rProduct" runat="server" OnItemDataBound="rProduct_ItemDataBound"
                                                            ...
                                                            <table class="table data-table-export table-hover nowrap">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th>Description</th>
                                                                        <th>CreatedDate</th>
                                                                        <th class="datable-nosort">Action</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                        </HeaderTemplate>
                                ...
                                <!-- Closing the card-block div -->
                            </div>
                            <!-- Closing the card div -->
                        </div>
                        <!-- Closing the col-sm-12 div -->
                    </div>
                    <!-- Closing the row div -->
                </div>
                <!-- Closing the page-body div -->
            </div>
            <!-- Closing the page-wrapper div -->
        </div>
        <!-- Closing the main-body div -->
    </div>
